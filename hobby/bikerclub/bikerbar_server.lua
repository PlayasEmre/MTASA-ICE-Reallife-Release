...
MtxSetElementData ( MistysFreeway1, "owner", "console" )
...
MtxSetElementData ( MistysFreeway2, "owner", "console" )
...
MtxSetElementData ( MistysFreeway3, "owner", "console" )
...
MtxSetElementData ( MistysFreeway4, "owner", "console" )
...
function bikerBarBuyQue_func ( player )
	...
	if MtxGetElementData ( player, "club" ) == "biker" then
		...
		if money >= quePrice then
			MtxSetElementData ( player, "money", money - quePrice )
...
function bikerBarJoin_func ( player )
	...
	if MtxGetElementData ( player, "club" ) == "biker" then
		...
		local money = tonumber ( MtxGetElementData ( player, "money" ) )
		if money >= 100 then
			MtxSetElementData ( player, "money", money - 100 )
			playSoundFrontEnd ( player, 40 )
			MtxSetElementData ( player, "club", "biker" )
...
function bikerBarBuySkin_func ( player )
	...
	if MtxGetElementData ( player, "club" ) == "biker" then
		local money = tonumber ( MtxGetElementData ( player, "money" ) )
		if MtxGetElementData ( player, "money" ) >= outfitPrice then
			MtxSetElementData ( player, "money", money - outfitPrice )
			playSoundFrontEnd ( player, 40 )
			MtxSetElementData ( player, "skinid", 254 )
