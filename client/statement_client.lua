...
function createNewStatementEntry_func ( name, value, text )
	...
	if value > 0 then
		value = "+ "..value.." "..Tables.waehrung..""
	elseif value < 0 then
		value = "- "..math.abs ( value ).." "..Tables.waehrung..""
	else
		value = "0 "..Tables.waehrung..""
	end
	value = value.."\n"
...
function getStatementFile ()
	...
	local file = xmlLoadFile ( ""..Tables.servername.."/money/money.xml" )
	if not file then
		file = xmlCreateFile ( ""..Tables.servername.."/money/money.xml", "Account" )
		xmlSaveFile ( file )
		file = xmlLoadFile ( ""..Tables.servername.."/money/money.xml" )
