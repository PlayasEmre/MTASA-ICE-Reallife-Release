...
function lookoutImage ( show )
	...
	local path = ":"..getResourceName(getThisResource()).."/images/lookout.png"
	local bPath = ":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg"
	...
	if show then
		...
		viewingNow = false
		for i = 1, 5 do
		if isElement(gImage["lookout"..i]) then
