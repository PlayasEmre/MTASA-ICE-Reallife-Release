		...
		function ( player )
			...
			if getElementInterior ( player ) == getElementInterior ( pickup ) and getElementDimension ( player ) == getElementDimension ( pickup ) then
				...
				if gotHorseShoes[player]["horseShoe"..i] == 0 then
					...
					local shoes = MtxGetElementData ( player, "totalHorseShoes" ) + 1
					MtxSetElementData ( player, "totalHorseShoes", shoes )
					if shoes == 25 then
						MtxSetElementData ( player, "bonuspoints", MtxGetElementData ( player, "bonuspoints" ) + 50 )
