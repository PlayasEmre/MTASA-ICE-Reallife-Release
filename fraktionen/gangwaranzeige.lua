...
local reichweiteZumTK = 20   -- Mindestreichweite zum TK, um drin zu sein - ACHTUNG: Serverseitig auch ändern!
...
function dxdrawGangwarAnzeige ()
	...
	if thepickup and isElement ( thepickup ) then
		...
		local xpl, ypl, zpl = getElementPosition ( localPlayer )
	...
	dxDrawImage(screenx-385*sxA, screeny-713*syA, 25*sxA, 25*syA, ":"..getResourceName(getThisResource()).."/images/kill.png", 0, 0, 0, tocolor(255, 255, 255, 255), true) -- KILLS
	dxDrawImage(screenx-260*sxA, screeny-713*syA, 25*sxA, 25*syA, ":"..getResourceName(getThisResource()).."/images/damage.png", 0, 0, 0, tocolor(255, 255, 255, 255), true) -- DAMAGE
	dxDrawImage(screenx-135*sxA, screeny-713*syA, 25*sxA, 25*syA, ":"..getResourceName(getThisResource()).."/images/time.png", 0, 0, 0, tocolor(255, 255, 255, 255), true) -- TIME
...
function kachingsound_func ( )
	playSound ( ":"..getResourceName(getThisResource()).."/sounds/kaching.mp3" )
end
