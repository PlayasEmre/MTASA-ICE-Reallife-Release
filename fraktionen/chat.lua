...
factionRankNames = {}
	...
	factionRankNames[i] = {}
		factionRankNames[i][0] = "Rekrut"
		factionRankNames[i][1] = "Soldat"
		factionRankNames[i][2] = "Offizier"
		factionRankNames[i][3] = "Ausbilder"
		factionRankNames[i][4] = "Kompanie Chef"
		factionRankNames[i][5] = "Kommandeur"
	i = i + 1
	factionColours[i] = {}
	...
	i = i + 1
	factionColours[i] = {}
         factionColours[i][1], factionColours[i][2], factionColours[i][3] = 255, 255 ,173
	factionRankNames[i] = {}
		factionRankNames[i][0] = "Opfer"
		factionRankNames[i][1] = "Computer-Freak"
		factionRankNames[i][2] = "Script-Kiddie"
		factionRankNames[i][3] = "Programmierer"
		factionRankNames[i][4] = "Installateur"
		factionRankNames[i][5] = "Hacker"
	i = i + 1
	factionColours[i] = {}
         factionColours[i][1], factionColours[i][2], factionColours[i][3] = 255, 255 ,255
	factionRankNames[i] = {}
		factionRankNames[i][0] = "Anfänger"
		factionRankNames[i][1] = "Anfänger-Azubi"
		factionRankNames[i][2] = "Auszubildende"
		factionRankNames[i][3] = "Ausbilder"
		factionRankNames[i][4] = "Ausbilder-Fahrlehrer"
		factionRankNames[i][5] = "Fahrleiter"
...
function teamchat_func ( player, cmd, ... )	
	...
	local FRank = MtxGetElementData ( player, "rang" )
...
function gteamchat_func ( player, cmd, ... )	
		...
		local FRank = tonumber(MtxGetElementData ( player, "rang" ))
