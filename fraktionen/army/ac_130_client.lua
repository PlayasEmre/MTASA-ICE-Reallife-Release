...
function joinAC130Gun ( camPos )
	...
	fireEnabled = true
	gImage["ac130Grey"] = guiCreateStaticImage ( 1, 1, screenwidth, screenheight, ":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg", false )
	guiSetAlpha ( gImage["ac130Grey"], 0.3 )
	gImage["cross-hair"] = guiCreateStaticImage ( screenwidth / 2 - 200 /2, screenheight / 2 - 100 / 2, 200, 100, ":"..getResourceName(getThisResource()).."/images/cross-hair.png", false )
