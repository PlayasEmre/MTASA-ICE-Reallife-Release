...
function formationSpeedUp ()
	...
	if veh then
		if getElementModel ( veh ) == 463 and getElementData ( lp, "fraktion" ) == 9 then
			-- Erst hier abschalten, nicht schon oben: sonst blieb bei jedem
			-- anderen Fahrzeug oder jeder anderen Fraktion der Sturz vom
			-- Motorrad dauerhaft deaktiviert, weil er nur beim Aussteigen aus
			-- einer Freeway (463) wieder eingeschaltet wird.
