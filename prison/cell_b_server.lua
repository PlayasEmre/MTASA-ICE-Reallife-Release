...
function Zell_Function_B ( mouseButton, buttonState, ele )
	...
	if buttonState == "up" then
		...
		if not MtxGetElementData( ele, "objectCellInfoB" ) or MtxGetElementData( ele, "objectCellInfoB" ) == nil then
			return
		end
		
		local number = tonumber(MtxGetElementData( ele, "objectCellInfoB" ))
