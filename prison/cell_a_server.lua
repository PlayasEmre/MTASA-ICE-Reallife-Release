...
function Zell_Function_A ( mouseButton, buttonState, ele )
	...
	if buttonState == "up" then
		...
		if not MtxGetElementData( ele, "objectCellInfoA" ) or MtxGetElementData( ele, "objectCellInfoA" ) == nil then
			return
		end
		
		local number = tonumber(MtxGetElementData( ele, "objectCellInfoA" ))
