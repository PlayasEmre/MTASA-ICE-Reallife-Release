...
function Zell_Function_C ( mouseButton, buttonState, ele )
	...
	if buttonState == "up" then
		...
		if not MtxGetElementData( ele, "objectCellInfoC" ) or MtxGetElementData( ele, "objectCellInfoC" ) == nil then
			return
		end
		
		local number = tonumber(MtxGetElementData( ele, "objectCellInfoC" ))
