...
function Zell_Function_E ( mouseButton, buttonState, ele )
	...
	if buttonState == "up" then
		...
		if not MtxGetElementData( ele, "objectCellInfoE" ) or MtxGetElementData( ele, "objectCellInfoE" ) == nil then
			return
		end
		
		local number = tonumber(MtxGetElementData( ele, "objectCellInfoE" ))
