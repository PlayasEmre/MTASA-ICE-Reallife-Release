...
function Zell_Function_D ( mouseButton, buttonState, ele )
	...
	if buttonState == "up" then
		...
		if not MtxGetElementData( ele, "objectCellInfoD" ) or MtxGetElementData( ele, "objectCellInfoD" ) == nil then
			return
		end
		
		local number = tonumber(MtxGetElementData( ele, "objectCellInfoD" ))
