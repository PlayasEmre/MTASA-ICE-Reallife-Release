...
function gunbuyGunshop_func ( player, itemtype, item,  w0, w1, w2, w3, w4, w5, w6, w7 )
	...
	if player == client then
		...
		if itemtype == "armor" then
			if MtxGetElementData ( player, "money" ) >= armor_gunshop_price then
				MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - armor_gunshop_price )
		...
		elseif itemtype == "ammo" then
			if item == "9mmammo" then
				if MtxGetElementData ( player, "money" ) >= pistolammo_gunshop_price then
					if w2 == 22 or w2 == 23 then
						MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - pistolammo_gunshop_price )
			...
			if item == "eagleammo" then
				if MtxGetElementData ( player, "money" ) >= eagleammo_gunshop_price then
						if w2 == 24 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - eagleammo_gunshop_price )
			...
			if item == "mp5ammo" then
				if MtxGetElementData ( player, "money" ) >= mpammo_gunshop_price then
						if w4 == 29 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - mpammo_gunshop_price )
			...
			if item == "schrot" then
				if MtxGetElementData ( player, "money" ) >= shotgunammo_gunshop_price then
						if w3 == 25 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - shotgunammo_gunshop_price )
			...
			if item == "ak47ammo" then
				if MtxGetElementData ( player, "money" ) >= akammo_gunshop_price then
						if w5 == 30 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - akammo_gunshop_price )
			...
			if item == "m4ammo" then
				if MtxGetElementData ( player, "money" ) >= mammo_gunshop_price then
						if w5 == 31 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - mammo_gunshop_price )
			...
			if item == "gewehrammo" then
				if MtxGetElementData ( player, "money" ) >= gewehrammo_gunshop_price then
						if w6 == 33 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - gewehrammo_gunshop_price )
			...
			if item == "sgewehrammo" then
				if MtxGetElementData ( player, "money" ) >= sgewehrammo_gunshop_price then
						if w6 == 34 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - sgewehrammo_gunshop_price )
							giveWeapon ( player, w6, 1, true )
							success = 1
						else
							triggerClientEvent ( player, "infobox_start", getRootElement(), "\n\nDu hast kein\nGewehr!", 5000, 125, 0, 0 )
		...
		elseif itemtype == "gun" then
			if item == "baseballbat" then
				if MtxGetElementData ( player, "money" ) >= baseball_gunshop_price then
						if w1 ~= 5 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - baseball_gunshop_price )
			...
			if item == "schaufel" then
				if MtxGetElementData ( player, "money" ) >= shovels_gunshop_price then
						if w1 ~= 6 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - shovels_gunshop_price )
			...
			if item == "messer" then
				if MtxGetElementData ( player, "money" ) >= knife_gunshop_price then
						if w1 ~= 4 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - knife_gunshop_price )
			...
			if item == "schlagring" then
				if MtxGetElementData ( player, "money" ) >= schlagringe_gunshop_price then
						if w1 == 0 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - schlagringe_gunshop_price )
			...
			if item == "9mm" then
				if MtxGetElementData ( player, "money" ) >= pistol_gunshop_price then
						if w2 ~= 22 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - pistol_gunshop_price )
			...
			if item == "9mmsd" then
				if MtxGetElementData ( player, "money" ) >= sdpistol_gunshop_price then
						if w2 ~= 23 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - sdpistol_gunshop_price )
			...
			if item == "eagle" then
				if MtxGetElementData ( player, "money" ) >= eagle_gunshop_price then
						if w2 ~= 24 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - eagle_gunshop_price )
			...
			if item == "mp5" then
				if MtxGetElementData ( player, "money" ) >= mp_gunshop_price then
						if w4 ~= 29 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - mp_gunshop_price )
			...
			if item == "shotty" then
				if MtxGetElementData ( player, "money" ) >= shotgun_gunshop_price then
						if w3 ~= 25 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - shotgun_gunshop_price )
			...
			if item == "ak47" then
				if MtxGetElementData ( player, "money" ) >= ak_gunshop_price then
						if w5 ~= 30 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - ak_gunshop_price )
			...
			if item == "m4" then
				if MtxGetElementData ( player, "money" ) >= m_gunshop_price then
						if w5 ~= 31 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - m_gunshop_price )
			...
			if item == "gewehr" then
				if MtxGetElementData ( player, "money" ) >= gewehr_gunshop_price then
						if  w6 ~= 33 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - gewehr_gunshop_price )
			...
			if item == "sniper" then
				if MtxGetElementData ( player, "money" ) >= sgewehr_gunshop_price then
						if w6 ~= 34 then
							MtxSetElementData ( player, "money", MtxGetElementData ( player, "money" ) - sgewehr_gunshop_price )
