...
function stripperAnimations ()
	...
	for i = 1, 7 do
		...
		MtxSetElementData ( _G["nuttedance"..i], "sx", x )
		MtxSetElementData ( _G["nuttedance"..i], "sy", y )
		MtxSetElementData ( _G["nuttedance"..i], "sz", z )
		MtxSetElementData ( _G["nuttedance"..i], "dim", 0 )
		if i <= 4 then
			MtxSetElementData ( _G["nuttedance"..i], "int", 3 )
		else
			MtxSetElementData ( _G["nuttedance"..i], "int", 2 )
		end
		MtxSetElementData ( _G["nuttedance"..i], "rot", getPedRotation ( _G["nuttedance"..i] ) )
		MtxSetElementData ( _G["nuttedance"..i], "botname", "nuttedance"..i )
	end
