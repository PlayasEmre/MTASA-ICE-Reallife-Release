...
function showWebbrowser ( url, prev )
	...
	if gWindow["basicMainPage"] then
		...
		gWindow["basicMainPage"] = guiCreateStaticImage(screenwidth/2-419/2,screenheight/2-373/2,419,373,":"..getResourceName(getThisResource()).."/images/background.png",false)
...
function createBasicPage ( color )
	...
	gImage["MainPage"] = guiCreateStaticImage(10,65,400,299,":"..getResourceName(getThisResource()).."/images/colors/c_"..color..".jpg",false,gWindow["basicMainPage"])
