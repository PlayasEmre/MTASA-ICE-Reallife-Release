...
function ammunation_func ()
	...
	gImage["ammunationOptic"] = guiCreateStaticImage(271,0,5,55,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	gImage["ammunationOptic"] = guiCreateStaticImage(0,58,114,241,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	gImage["ammunationOptic"] = guiCreateStaticImage(114,53,5,246,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	gImage["ammunationOptic"] = guiCreateStaticImage(237,56,5,243,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	gImage["ammunationOpticMid"] = guiCreateStaticImage(119,58,118,241,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
	guiSetAlpha(gImage["ammunationOpticMid"],1)
	gImage["ammunationOptic"] = guiCreateStaticImage(0,53,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	gImage["ammunationOptic"] = guiCreateStaticImage(242,58,158,241,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
	guiSetAlpha(gImage["ammunationOptic"],1)
	
	gImage["ammunationLogo"] = guiCreateStaticImage(1,2,160,32,":"..getResourceName(getThisResource()).."/images/internet/ammunation.bmp",false,img)
	...
	gLabel["ammunationTotalCost"] = guiCreateLabel(351,5,100,19,"0 "..Tables.waehrung.."",false,img)
	...
	gLabel["ammunationText4"] = guiCreateLabel(280,27,116,15,"zzg. 500 "..Tables.waehrung.." Lieferungskosten",false,img)
	...
	-- WAFFEN --
	gCheck["ammunationPistol"] = guiCreateCheckBox(4,83,100,17,"9mm: "..pistol_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationDeagle"] = guiCreateCheckBox(4,112,100,17,"Deagle: "..eagle_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationShotgun"] = guiCreateCheckBox(4,141,100,17,"Shotgun: "..shotgun_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationMP5"] = guiCreateCheckBox(4,170,100,17,"MP5: "..mp_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationAK-47"] = guiCreateCheckBox(4,199,100,17,"AK-47: "..ak_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationM4"] = guiCreateCheckBox(4,228,100,17,"M4: "..m_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gCheck["ammunationGewehr"] = guiCreateCheckBox(4,257,100,17,"Gewehr: "..gewehr_gunshop_price..""..Tables.waehrung.."",false,false,img)
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25,77,19,"9mm: "..pistolammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*1,77,19,"Cal.50: "..eagleammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*2,77,19,"Schrot: "..shotgunammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*3,77,19,"MP5: "..mpammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*4,77,19,"AK-47: "..akammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*5,77,19,"M4: "..mammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gLabel["ammunation"..part.."Ammo"] = guiCreateLabel(40,25+29*6,77,19,"Patronen: "..gewehrammo_gunshop_price..""..Tables.waehrung.."",false,gImage["ammunationOpticMid"])
	guiLabelSetColor(gLabel["ammunation"..part.."Ammo"],255,255,255)
	guiLabelSetVerticalAlign(gLabel["ammunation"..part.."Ammo"],"top")
	guiLabelSetHorizontalAlign(gLabel["ammunation"..part.."Ammo"],"left",false)
	guiSetFont(gLabel["ammunation"..part.."Ammo"],"default-bold-small")
	...
	gCheck["ammunationArmor"] = guiCreateCheckBox(243,83,150,17,"Schutzweste: "..armor_gunshop_price..""..Tables.waehrung.."",false,false,img)
	guiSetFont(gCheck["ammunationArmor"],"default-bold-small")
	gCheck["ammunationNVG"] = guiCreateCheckBox(243,112,150,17,"Nachtsicht "..nvgoogles_price..""..Tables.waehrung.."",false,false,img)
	guiSetFont(gCheck["ammunationNVG"],"default-bold-small")
	gCheck["ammunationWVG"] = guiCreateCheckBox(243,141,150,17,"Waermesicht: "..tgoogles_price..""..Tables.waehrung.."",false,false,img)
...
function recalcObjects ()
	...
	guiSetText ( gLabel["ammunationTotalCost"], totalCosts.." "..Tables.waehrung.."" )
end