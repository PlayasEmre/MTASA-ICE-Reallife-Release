...
function ltr_func ()
	...
	gImage["LTR2"] = guiCreateStaticImage(31,0,330,91,":"..getResourceName(getThisResource()).."/images/liberty_tree.png",false,img)
	gImage["LTR3"] = guiCreateStaticImage(12,87,376,18,":"..getResourceName(getThisResource()).."/images/colors/c_green.jpg",false,img)
