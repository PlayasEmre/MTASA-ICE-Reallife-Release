...
gImage["Mafia2"] = guiCreateStaticImage(0,0,5,299,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Mafia3"] = guiCreateStaticImage(395,0,5,299,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Mafia4"] = guiCreateStaticImage(0,295,399,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Mafia5"] = guiCreateStaticImage(0,0,396,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
...
gImage["Mafia6"] = guiCreateStaticImage(263,17,41,49,":"..getResourceName(getThisResource()).."/images/dollar.png",false,img)
gImage["Mafia7"] = guiCreateStaticImage(76,17,43,51,":"..getResourceName(getThisResource()).."/images/dollar.png",false,img)
gImage["Mafia8"] = guiCreateStaticImage(2,66,398,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
...
gImage["Mafia9"] = guiCreateStaticImage(80,68,256,231,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Mafia10"] = guiCreateStaticImage(2,81,395,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Mafia11"] = guiCreateStaticImage(34,71,338,10,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
...
gImage["Mafia12"] = guiCreateStaticImage(77,86,259,6,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["Mafia13"] = guiCreateStaticImage(79,289,258,6,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
...
gImage["Mafia14"] = guiCreateStaticImage(95,262,35,25,":"..getResourceName(getThisResource()).."/images/internet/email.png",false,img)
