...
gImage["Bundeswehr2"] = guiCreateStaticImage(56,83,279,215,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr3"] = guiCreateStaticImage(0,295,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr4"] = guiCreateStaticImage(395,0,5,297,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr5"] = guiCreateStaticImage(0,0,5,297,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr6"] = guiCreateStaticImage(-1,0,399,7,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr7"] = guiCreateStaticImage(56,14,279,49,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr8"] = guiCreateStaticImage(2,71,397,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr9"] = guiCreateStaticImage(44,3,5,294,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gImage["Bundeswehr10"] = guiCreateStaticImage(342,2,5,297,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,img)
gButton["Bundeswehr1"] = guiCreateButton(137,269,167,23,"Kontaktiere diese Fraktion",false,img)
gImage["Bundeswehr11"] = guiCreateStaticImage(97,268,40,26,":"..getResourceName(getThisResource()).."/images/internet/email.png",false,img)
