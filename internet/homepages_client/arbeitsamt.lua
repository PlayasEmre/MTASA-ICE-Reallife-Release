...
gImage["Arge2"] = guiCreateStaticImage(0,34,5,265,":"..getResourceName(getThisResource()).."/images/colors/c_white.jpg",false,img)
gImage["Arge3"] = guiCreateStaticImage(394,35,6,264,":"..getResourceName(getThisResource()).."/images/colors/c_white.jpg",false,img)
gImage["Arge4"] = guiCreateStaticImage(0,0,400,57,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
...
gImage["Arge5"] = guiCreateStaticImage(0,293,395,6,":"..getResourceName(getThisResource()).."/images/colors/c_white.jpg",false,img)
gImage["Arge6"] = guiCreateStaticImage(3,57,393,5,":"..getResourceName(getThisResource()).."/images/colors/c_white.jpg",false,img)
...
gImage["Arge7"] = guiCreateStaticImage(19,70,46,35,":"..getResourceName(getThisResource()).."/images/dollar.png",false,img)
gImage["Arge8"] = guiCreateStaticImage(311,73,45,35,":"..getResourceName(getThisResource()).."/images/dollar.png",false,img)
...
gMemo["Arge1"] = guiCreateMemo(11,163,378,125,"Wir haben in unserer Beratungsstelle immer Zeit fuer sie.\nTreten sie einfach naeher und suchen sie sich einen Job aus,\nder zu Ihnen passt. Wir haben immer viele freie Stellen zur Verfuegung. Kommen sie einfach zur Stadtverwaltung und lassen sie sich beraten. Moegliche Jobs sind z.b. Fischer, Mechaniker, Trucker, Flughafenmitarbeiter oder HotDog Verkaeufer. Kommen sie einfach vorbei!",false,img)
gImage["Arge9"] = guiCreateStaticImage(0,0,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["Arge10"] = guiCreateStaticImage(-1,3,7,54,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["Arge11"] = guiCreateStaticImage(394,1,6,56,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
