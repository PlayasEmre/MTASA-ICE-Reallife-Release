...
addEventHandler ( maindomane, getRootElement(), 
	function  ()
		...
		gImage["BuyitBuyBG"] = guiCreateStaticImage(0,0,400,56,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
		gLabel[7] = guiCreateLabel(124,14,169,26,"BuyIt - "..auktionOffer.." kaufen",false,gImage["BuyitBuyBG"])
		gImage[3] = guiCreateStaticImage(60,6,41,40,":"..getResourceName(getThisResource()).."/images/internet/star.png",false,gImage["BuyitBuyBG"])
		gImage[4] = guiCreateStaticImage(0,51,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,gImage["BuyitBuyBG"])
		...
		gLabel[4] = guiCreateLabel(387,222,13,23,""..Tables.waehrung.."",false,img)
		...
		gLabel[6] = guiCreateLabel(272,98,67,18,"0 "..Tables.waehrung.."",false,img)
		...
		addEventHandler("onClientGUIClick", gGrid[1], 
			function ( btn, state )
				...
				if row and offerID ~= _G[row.."DataID"] then
					...
					guiSetText ( gLabel[6], gebot.." "..Tables.waehrung.."" )
...
function recieveDataForObjectList_func ( count, dataString )
	...
	for i = 1, count do
		...
		guiGridListSetItemText ( gGrid[1], row, gColumn["offerGebot"], hoechstgebot.." "..Tables.waehrung.."", false, false )
