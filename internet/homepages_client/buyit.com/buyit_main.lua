...
addEventHandler ( maindomane, getRootElement(), 
	function  ()
		...
		gImage[2] = guiCreateStaticImage(0,0,400,56,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
		gImage[3] = guiCreateStaticImage(60,6,41,40,":"..getResourceName(getThisResource()).."/images/internet/star.png",false,gImage[2])
		gImage[4] = guiCreateStaticImage(0,51,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg",false,gImage[2])
