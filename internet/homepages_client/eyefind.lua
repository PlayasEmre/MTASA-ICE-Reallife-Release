...
function eyefind_func ()
	...
	gImage[3] = guiCreateStaticImage(0,55,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
	gImage[4] = guiCreateStaticImage(6,67,129,30,":"..getResourceName(getThisResource()).."/images/liberty_tree.png",false,img)
	...
	gImage[5] = guiCreateStaticImage(5,139,111,28,":"..getResourceName(getThisResource()).."/images/internet/ammunation.bmp",false,img)
	...
	gImage[6] = guiCreateStaticImage(6,101,75,31,":"..getResourceName(getThisResource()).."/images/internet/sprunk.png",false,img)
	...
	false)
	gImage[7] = guiCreateStaticImage(0,0,400,56,":"..getResourceName(getThisResource()).."/images/colors/c_lblue.jpg",false,img)
	gImage[2] = guiCreateStaticImage(0,0,101,56,":"..getResourceName(getThisResource()).."/images/internet/eyefind.bmp",false,img)
	gImage[8] = guiCreateStaticImage(345,59,5,5,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,gImage[7])
	...
	gImage[9] = guiCreateStaticImage(4,171,113,24,":"..getResourceName(getThisResource()).."/images/internet/bank.png",false,img)
	...
	guiLabelSetHorizontalAlign(gLabel[5],"left",false)
	guiSetFont(gLabel[5],"default-bold-small")
	gImage[10] = guiCreateStaticImage(28,198,54,51,":"..getResourceName(getThisResource()).."/images/internet/pizza.jpg",false,img)
	...
	gImage[11] = guiCreateStaticImage(4,254,41,36,":"..getResourceName(getThisResource()).."/images/internet/star.png",false,img)
...
triggerServerEvent ( "emailCheck", localPlayer, emailCheck.type )
