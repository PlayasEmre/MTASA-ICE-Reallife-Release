...
function sprunk_func ()
	...
	gImage["Sprunk2"] = guiCreateStaticImage(83,0,223,99,":"..getResourceName(getThisResource()).."/images/internet/Sprunk.png",false,img)
	...
	gImage["Sprunk3"] = guiCreateStaticImage(-1,97,401,5,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
	...
	gLabel["Sprunk3"] = guiCreateLabel(100,148,181,15,"Eine Dose Sprunk kostet nur 1"..Tables.waehrung.."",false,img)
	...
	gImage["Sprunk4"] = guiCreateStaticImage(-2,134,401,5,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
	gImage["Sprunk5"] = guiCreateStaticImage(-1,193,401,6,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
	gImage["Sprunk6"] = guiCreateStaticImage(-1,199,401,100,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
	...
	gImage["Sprunk7"] = guiCreateStaticImage(0,0,400,97,":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg",false,img)
