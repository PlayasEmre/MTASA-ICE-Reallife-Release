...
gImage["FBI2"] = guiCreateStaticImage(0,0,400,5,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
gImage["FBI3"] = guiCreateStaticImage(393,0,7,299,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
gImage["FBI4"] = guiCreateStaticImage(0,291,396,8,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
gImage["FBI5"] = guiCreateStaticImage(0,0,7,299,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
gImage["FBI6"] = guiCreateStaticImage(6,50,390,13,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
gImage["FBI7"] = guiCreateStaticImage(15,10,370,34,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
...
gImage["FBI8"] = guiCreateStaticImage(40,74,316,218,":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg",false,img)
...
gImage["FBI9"] = guiCreateStaticImage(85,256,55,30,":"..getResourceName(getThisResource()).."/images/internet/email.png",false,img)
gButton["FBI1"] = guiCreateButton(151,259,178,21,"Kontaktiere diese Fraktion",false,img)
gImage["FBI10"] = guiCreateStaticImage(37,284,326,7,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
end
