...
function bank_func ()
	...
	gImage["Bankbild1"] = guiCreateStaticImage(78,16,235,59,":"..getResourceName(getThisResource()).."/images/internet/bank.png",false,img)
	...
	gImage["Bank3"] = guiCreateStaticImage(266,127,43,36,":"..getResourceName(getThisResource()).."/images/dollar.png",false,img)
	...
	gLabel["Bank4"] = guiCreateLabel(85,102,300,20,"Sie haben "..tostring(bankmoney).." "..Tables.waehrung.." auf der Bank.",false,img)
	...
	gLabel["Bank7"] = guiCreateLabel(92,233,227,16,"von 10"..Tables.waehrung.." pro Ueberweisung.",false,img)
