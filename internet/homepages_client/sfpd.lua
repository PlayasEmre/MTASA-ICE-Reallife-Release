...
gImage["SFPD2"] = guiCreateStaticImage(0,0,11,270,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["SFPD3"] = guiCreateStaticImage(0,258,360,12,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["SFPD4"] = guiCreateStaticImage(349,0,11,268,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
gImage["SFPD5"] = guiCreateStaticImage(76,6,209,62,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
...
gImage["SFPD6"] = guiCreateStaticImage(9,0,343,6,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false,img)
...
gImage["SFPD7"] = guiCreateStaticImage(82,224,43,31,":"..getResourceName(getThisResource()).."/images/internet/email.png",false,img)
gImage["SFPD8"] = guiCreateStaticImage(349,258,10,10,":"..getResourceName(getThisResource()).."/images/pokal.jpg",false,img)
gImage["SFPD9"] = guiCreateStaticImage(-1,258,13,11,":"..getResourceName(getThisResource()).."/images/pokal.jpg",false,img)
end
