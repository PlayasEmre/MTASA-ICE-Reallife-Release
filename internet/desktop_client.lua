...
function showFruitDesktop_func ()
	...
	if gImage["desktopBG"] then
		...
		gImage["desktopBG"] = guiCreateStaticImage(screenwidth/2-480/2,screenheight/2-272/2,480,272,":"..getResourceName(getThisResource()).."/images/internet/bg.png",false)
		guiSetAlpha ( gImage["desktopBG"], 0 )
		setTimer ( fadeFruitImage, 50, 20, gImage["desktopBG"] )
		gImage["desktopEmail"] = guiCreateStaticImage(43,48,60,46,":"..getResourceName(getThisResource()).."/images/internet/email.png",false,gImage["desktopBG"])
		...
		gImage["desktopLogout"] = guiCreateStaticImage(48,176,62,46,":"..getResourceName(getThisResource()).."/images/internet/logout.png",false,gImage["desktopBG"])
		...
		gImage["desktopBank"] = guiCreateStaticImage(345,52,104,35,":"..getResourceName(getThisResource()).."/images/internet/bank.png",false,gImage["desktopBG"])
		...
		gLabel["desktopInfo"] = guiCreateLabel(37,253,441,17,"Angemeldet als: "..pname.." ( "..pname.."@"..Tables.servername.."-Reallife.de )",false,gImage["desktopBG"])
		...
		gImage["desktopAmmunation"] = guiCreateStaticImage(343,180,113,32,":"..getResourceName(getThisResource()).."/images/internet/ammunation.bmp",false,gImage["desktopBG"])
		...
		addEventHandler("onClientGUIClick", gImage["desktopLogout"], 
			function ()
				gImage["blackScreen"] = guiCreateStaticImage(screenwidth/2-480/2,screenheight/2-272/2,480,272,":"..getResourceName(getThisResource()).."/images/colors/c_black.jpg",false)
