...
function calcFishingSkillLevel ( player )
	...
	local skill = MtxGetElementData and MtxGetElementData( player, "fishingSkill" ) or vioClientGetElementData ( "fishingSkill" )
	if skill < 10 then
		return 1
...
function calcGambleSkillLevel ( player )
	...
	local skill = MtxGetElementData and MtxGetElementData ( player, "gambleSkill" ) or vioClientGetElementData ( "gambleSkill" )
	if skill <= 500 then
		return 1
	elseif skill <= 2000 then
		return 2
