...
function increasePlayerFishingSkillLevel ( player, amount )
	...
	MtxSetElementData ( player, "fishingSkill", MtxGetElementData ( player, "fishingSkill" ) + amount )
	
	local skill = MtxGetElementData ( player, "fishingSkill" )
...
function increasePlayerGambleSkillLevel ( player, amount )
	...
	MtxSetElementData ( player, "gambleSkill", MtxGetElementData ( player, "gambleSkill" ) + amount )
	
	local skill = MtxGetElementData ( player, "gambleSkill" )
