...
maxplayers = 100
wctime = 20
speznr = { [110]=true, [112]=true, [300]=true } -- 110=Polizei, 112=Sanitäter, 300=Mechaniker
tramSpeed = 0.35
aktionpuffer = 3*60*1000
healafterdmgtime = 3*0*000
...
validResources = { ["realdriveby"]=true, ["parachute"]=true, ["dream"]=true }
