...
Tables = { 
	servername = "ICE", --Der Server Name  Beachtet bitte wenn ihr den Servernamen ändert dass diese Ressource gleich heißen muss
	tsip = "Nicht vorhanden",
	noobtime = 180,
	forumURL = "Nicht vorhanden", 
	waehrung = "€",
	ScriptVersion = "5.0",
	tablist = "ICE",
	m_EXP = 100,
...
event = {
	...
	islogin = true,
	promo0 = true,
	isBeta = true, --Beta-Zugangscode-Pflicht vor dem Login (beta/beta_server.lua)
}

globalTables={
	["Tasks"]={
		[1]="Miete einen Roller.\nBelohnung: €1500",
        [2]="Kaufe einen Personal Ausweis in der Stadthalle.\nBelohnung: €2500",
        [3]="Öffne das Hilfemenü(F1).\nBelohnung: €2000",
        [4]="Machen sie einen Führerschein.\nBelohnung: €4000",
        [5]="Kauf dir den LKW-Schein.\nBelohnung: €4500",
        [6]="Gehe als Busfahrer arbeiten.\nBelohnung: €4000",
	},
}

guimaincolor=tocolor(0,0,220,220)
...
evilFraction = { [2] = true, [3] = true, [4] = true, [7] = true, [9] = true, [12] = true, [13] = true, [14] = true, [15] = true }
...
-- Fraktionen --
fraktionsNamen = { [1]="Polizei", [2]="Mafia", [3]="Triaden", [4]="Terroristen", [5]="SAN News", [6]="FBI", [7]="Los Aztecas", [8]="Bundeswehr", [9]="Angels of Death", [10]="Sanitäter", [11]="Mechaniker", [12]="Ballas", [13]="Grove",[14]="Anonymus" } 
