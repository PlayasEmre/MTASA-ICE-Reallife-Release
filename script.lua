...
function mainTimer ()
	...
	local dieseMinute = hour * 60 + minute
	if dieseMinute == letzteMinute then return end
	letzteMinute = dieseMinute
	...
	elseif hour == 4 and minute == 55 then
