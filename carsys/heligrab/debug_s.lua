...
addEventHandler("onResourceStart", resourceRoot,
	function()
		if _DEBUG then
			...
			testVehicle = createVehicle(487,-1990.3149414063,157.38885498047,27.5390625, 0, 0, 90)
			setElementFrozen(testVehicle, true)
				
			elements = {}
				
			local v = createVehicle(487, -1990.3149414063,157.38885498047,27.5390625, 0, 0, 90)
			local p = createPed(0, -1990.3149414063,157.38885498047,27.5390625)
			...
			v = createVehicle(487, -1990.3149414063,157.38885498047,27.5390625, 0, 0, 90)
			p = createPed(0, -1990.3149414063,157.38885498047,27.5390625)
			warpPedIntoVehicle(p, v)
