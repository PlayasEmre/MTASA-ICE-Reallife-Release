...
function createKatjuscha ( x, y, z, rx, ry, rz )
	...
	MtxSetElementData ( katjuschaArray[katjCount]["vehicle"], "katjuscha", true )
	MtxSetElementData ( katjuschaArray[katjCount]["vehicle"], "fireAble", true )
	MtxSetElementData ( katjuschaArray[katjCount]["vehicle"], "katjuschaID", katjCount )
	for i = 1, 4 do
...
function fireKatjuscha ( id, x, y, z )
	...
	if player and isTerror ( player ) then
		if MtxGetElementData ( katjuscha, "fireAble" ) then
			MtxSetElementData ( katjuscha, "fireAble", false )
			setTimer ( MtxSetElementData, 60*kS, 1, katjuscha, "fireAble", true )
...
function katjuscha_func ( p )
	if isTerror ( p ) and MtxGetElementData ( p, "rang" ) >= 4 then
