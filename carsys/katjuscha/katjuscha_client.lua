...
function fireKatjuschaRocketClient_func ( player, veh, id, rID, x2, y2, z2, SAM )
	...
	moveObject ( katjuschaArray[id][rID]["Rocket"], movingTime,  x3, y3, z2 + addHight, 0, -30)
	setTimer ( moveObject, movingTime, 1, katjuschaArray[id][rID]["Rocket"], movingTime, x2+math.random(-7,7), y2+math.random(-7,7), z2, 0, -30)
