...
function startDrugEffect_func ( time, amount, drunk, stone ) -- In 1000tel Sekunden bzw. MS; 0-1 in Heftigkeit -> 1 = Extrem, 0 = Nicht spürbar
	...
	if drugColors["white"] then
		...
		drugColors["white"] = guiCreateStaticImage ( 0, 0, screenwidth, screenheight, ":"..getResourceName(getThisResource()).."/images/white.bmp", false )
		guiSetAlpha ( drugColors["white"], 0.5 )
		guiMoveToBack ( drugColors["white"] )
		
		drugColors["red"] = guiCreateStaticImage ( 0, 0, screenwidth, screenheight, ":"..getResourceName(getThisResource()).."/images/colors/c_red.jpg", false )
		guiSetAlpha ( drugColors["red"], 0 )
		guiMoveToBack ( drugColors["red"] )
		
		drugColors["green"] = guiCreateStaticImage ( 0, 0, screenwidth, screenheight, ":"..getResourceName(getThisResource()).."/images/colors/c_green.jpg", false )
		guiSetAlpha ( drugColors["green"], 0 )
		guiMoveToBack ( drugColors["green"] )
		
		drugColors["blue"] = guiCreateStaticImage ( 0, 0, screenwidth, screenheight, ":"..getResourceName(getThisResource()).."/images/colors/c_blue.jpg", false )
...
function deactivateDrugEffect_func ()
	...
	if isTimer ( drugEffectTimer ) then killTimer ( drugEffectTimer ) end
