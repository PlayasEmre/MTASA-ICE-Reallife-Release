...
function getTotalAddictLevel ( player )
	...
	local points1 = MtxGetElementData and MtxGetElementData ( player, "cigarettAddictPoints" ) or vioClientGetElementData ( "cigarettAddictPoints" )
	local points2 = MtxGetElementData and MtxGetElementData ( player, "alcoholAddictPoints" ) or vioClientGetElementData ( "alcoholAddictPoints" )
	local points3 = MtxGetElementData and MtxGetElementData ( player, "drugAddictPoints" ) or vioClientGetElementData ( "drugAddictPoints" )
...
function getCigarettAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = MtxGetElementData and MtxGetElementData ( player, "cigarettAddictPoints" ) or vioClientGetElementData ( "cigarettAddictPoints" )
...
function getAlcoholAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = MtxGetElementData and MtxGetElementData ( player, "alcoholAddictPoints" ) or vioClientGetElementData ( "alcoholAddictPoints" )
...
function getDrugAddictLevel ( player )
	...
	if isElement ( player ) then
		local points = MtxGetElementData and MtxGetElementData ( player, "drugAddictPoints" ) or vioClientGetElementData ( "drugAddictPoints" )
