...
function showChipBuy_func ()
	...
	if isElement ( gWindow["chipBuy"] ) then
		...
		dgsBringToFront ( gWindow["chipBuy"] )
	else
		gWindow["chipBuy"] = dgsCreateWindow(screenwidth/2-229/2,screenheight/2-188/2,229,188,"Chips",false,nil,nil,nil,nil,nil,nil,nil,true)
		dgsBringToFront ( gWindow["chipBuy"] )
