...
function getNewRoulettDrawNumber ( number )
	...
	gImage["roulettBasicBG"] = guiCreateStaticImage ( screenwidth/2-roulettRandomFieldSizeX/2, 0, roulettRandomFieldSizeX, roulettRandomFieldSizeY, ":"..getResourceName(getThisResource()).."/images/colors/c_"..color..".jpg", false )
end

function showRoulettWinningNumber_func ( finalNumber, total )

	if finalNumber then
		gImage["roulettBasicBorder1"] = guiCreateStaticImage ( screenwidth/2-roulettRandomFieldSizeX/2 - 5, 0, 5, roulettRandomFieldSizeY, ":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg", false )
		gImage["roulettBasicBorder2"] = guiCreateStaticImage ( screenwidth/2+roulettRandomFieldSizeX/2, 0, 5, roulettRandomFieldSizeY, ":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg", false )
		gImage["roulettBasicBorder3"] = guiCreateStaticImage ( screenwidth/2+roulettRandomFieldSizeX/2 - roulettRandomFieldSizeX - 5, roulettRandomFieldSizeY, roulettRandomFieldSizeX + 10, 5, ":"..getResourceName(getThisResource()).."/images/colors/c_grey.jpg", false )
...
function showRoulettInfo ( total )
	...
	local r, g, b = 0, 0, 0
	if total < 0 then
		roulettBetInfoText = "Du verlierst "..math.abs(total).." "..Tables.waehrung..""
		r = 150
	elseif total == 0 then
		roulettBetInfoText = "Du gehst leer aus."
		r, g, b = 150, 150, 150
	elseif total > 0 then
		roulettBetInfoText = "Du gewinnst "..total.." "..Tables.waehrung..""
		g = 150
	end
	roulettBetInfoR = r
	roulettBetInfoG = g
