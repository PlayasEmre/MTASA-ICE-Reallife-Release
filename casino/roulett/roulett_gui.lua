...
function showRoulettWindow ()
	...
	if isElement ( gWindow["roulett"] ) then
		...
		gLabel[1] = guiCreateLabel(106,92,50,14,""..Tables.waehrung.." / Chips",false,gWindow["roulett"])
		...
		gImage[1] = guiCreateStaticImage(16,135,37,40,":"..getResourceName(getThisResource()).."/images/inventory/chip.png",false,gWindow["roulett"])
