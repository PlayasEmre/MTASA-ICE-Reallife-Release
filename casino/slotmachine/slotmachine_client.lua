...
["Marker"] = createMarker ( 1963.6403808594 ,998.6240234375 ,991.4677734375, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
["Marker"] = createMarker (1966.3140869141 ,998.13726806641 ,991.46875, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
["Marker"] = createMarker ( 1963.5222167969 ,1037.0356445313 ,991.47448730469, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
["Marker"] = createMarker ( 1966.029296875 ,1037.5712890625 ,991.46875, "cylinder", 1, 255, 0, 0, 255,false,getRootElement()  ),
...
["Marker"] = createMarker ( 2268.119140625,1606.556640625,1006.1796875, "cylinder", -0.95, 255, 0, 0, 255,false,getRootElement() ), 
...
["Marker"] = createMarker ( 2216.0598144531 ,1603.8572998047 ,1005.1041870117, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
["Marker"] = createMarker ( 2218.4145507813 ,1603.8337402344 ,1005.0786132813, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
["Marker"] = createMarker ( 2270.7658691406 ,1606.6799316406 ,1005.1286621094, "cylinder", 1, 255, 0, 0, 255,false,getRootElement() ),
...
function showwintext(amount)
	dxDrawText("Du gewinnst "..slotMachineWinAmount.." "..Tables.waehrung.."!",4,4,screenwidth+4,screenheight+4,tocolor(0,0,0,255),3,"pricedown","center","center",false,false,true)
	dxDrawText("Du gewinnst "..slotMachineWinAmount.." "..Tables.waehrung.."!",2,2,screenwidth+2,screenheight+2,tocolor(0,150,0,255),3,"pricedown","center","center",false,false,true)
end
...
function startbandit(btn,state,slot)
	triggerServerEvent("Slot", localPlayer,localPlayer,slot)
	disableBinds()
end
