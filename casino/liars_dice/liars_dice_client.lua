...
function openLiarsDiceServerList_func ( string, count )
	...
	gLabel[1] = guiCreateLabel(85,265,15,21,""..Tables.waehrung.."",false,gWindow["liarsDice"])
...
function drawDiceBar ( x, y, dices, parent )
	...
	local bg = guiCreateStaticImage ( x, y, ( 2 * 6 + 16 * 5 ) * sizeMultipli, ( 2 * 2 + 16 * 1 ) * sizeMultipli, ":"..getResourceName(getThisResource()).."/images/colors/c_green.jpg", false, parent )
	
	for i = 0, 4 do
		guiCreateStaticImage ( ( 2 + i * 16 + i * 2 ) * sizeMultipli, ( 2 ) * sizeMultipli, ( 16 ) * sizeMultipli, ( 16 ) * sizeMultipli, ":"..getResourceName(getThisResource()).."/images/cards/dices/"..dices[(i+1)]..".png", false, bg )
	end
end
...
function recieveBetFieldData ( from, eye, count, total, own )
	...
	gImage["ownDice"] = guiCreateStaticImage(306-50,49,24,24,":"..getResourceName(getThisResource()).."/images/cards/dices/"..eye..".png",false,gWindow["liarsDiceGame"])
	...
	if own then
		gImage["liarsDiceEyeDown"] = guiCreateStaticImage(310-50,76,16,13.5,":"..getResourceName(getThisResource()).."/images/cards/dices/arrow_down.png",false,gWindow["liarsDiceGame"])
		guiSetAlpha(gImage["liarsDiceEyeDown"],1)
		gImage["liarsDiceEyeUp"] = guiCreateStaticImage(310-50,33,16,13.5,":"..getResourceName(getThisResource()).."/images/cards/dices/arrow_up.png",false,gWindow["liarsDiceGame"])
		guiSetAlpha(gImage["liarsDiceEyeUp"],1)
		gImage["liarsDiceEyeCountDown"] = guiCreateStaticImage(280-50,76,16,13.5,":"..getResourceName(getThisResource()).."/images/cards/dices/arrow_down.png",false,gWindow["liarsDiceGame"])
		guiSetAlpha(gImage["liarsDiceEyeCountDown"],1)
		gImage["liarsDiceEyeCountUp"] = guiCreateStaticImage(280-50,33,16,13.5,":"..getResourceName(getThisResource()).."/images/cards/dices/arrow_up.png",false,gWindow["liarsDiceGame"])
...
function showLiarsDiceMainMenue ()
	...
	gImage["player1Dices"] = guiCreateStaticImage(30,49+58*1,138,30,":"..getResourceName(getThisResource()).."/images/colors/c_green.jpg",false,gWindow["liarsDiceGame"])
	...
	gImage["player1Dices"] = guiCreateStaticImage(30,49+58*2,138,30,":"..getResourceName(getThisResource()).."/images/colors/c_green.jpg",false,gWindow["liarsDiceGame"])
	guiSetAlpha(gImage["player1Dices"],1)
