...
function showPokerActionMenue_func ( ownBet, minBet, raisePossible )
	...
	gLabel["pokerDrawOwnBet"] = guiCreateLabel(87,40,89,15,ownBet.." "..Tables.waehrung.."",false,gWindow["pokerDraw"])
	...
	gLabel["pokerDrawMinBet"] = guiCreateLabel(88,66,89,15,minBet.." "..Tables.waehrung.."",false,gWindow["pokerDraw"])
	...
	gLabel["pokerDraw4"] = guiCreateLabel(112,135,100,19,""..Tables.waehrung.." erhoehen",false,gWindow["pokerDraw"])
