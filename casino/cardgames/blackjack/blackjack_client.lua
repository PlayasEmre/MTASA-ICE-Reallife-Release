...
function createBlackJackCard ( card, x, y, w, h, parentElement )
	...
	if card then
		if card > -1 then
			...
			if card == 0 then
				gImage["cardBG"..cardNR] = guiCreateStaticImage(x,y,w,h,":"..getResourceName(getThisResource()).."/images/cards/images/back.png",false,parentElement)
				guiSetAlpha(gImage["cardBG"..cardNR],1)
			elseif not ( getCardType ( card ) == 10 or getCardType ( card ) == 11 or getCardType ( card ) == 12 ) then
				gImage["cardBG"..cardNR] = guiCreateStaticImage(x,y,w,h,":"..getResourceName(getThisResource()).."/images/cards/images/bg.png",false,parentElement)
				guiSetAlpha(gImage["cardBG"..cardNR],1)
				local pfad = ":"..getResourceName(getThisResource()).."/images/cards/"..cardColors[getCardColor(card)].."/"..cardIDTypeName[getCardType(card)].."_"..cardColorsShort[getCardColor(card)]..".png"
				...
				gImage["cardDeko3"..cardNR] = guiCreateStaticImage(0.291,0.3231,0.4403,0.3231,":"..getResourceName(getThisResource()).."/images/cards/symbols/"..getFittingSymbol(card)..".png",true,gImage["cardBG"..cardNR])
				guiSetAlpha(gImage["cardDeko3"..cardNR],1)
				gImage["cardDeko4"..cardNR] = guiCreateStaticImage(0.0448,0.8515,0.2015,0.1354,":"..getResourceName(getThisResource()).."/images/cards/symbols/"..getFittingSymbol(card)..".png",true,gImage["cardBG"..cardNR])
				guiSetAlpha(gImage["cardDeko4"..cardNR],1)
				gImage["cardDeko5"..cardNR] = guiCreateStaticImage(0.7687,0.0218,0.2015,0.1354,":"..getResourceName(getThisResource()).."/images/cards/symbols/"..getFittingSymbol(card)..".png",true,gImage["cardBG"..cardNR])
				guiSetAlpha(gImage["cardDeko5"..cardNR],1)
			else
				gImage["cardBG"..cardNR] = guiCreateStaticImage(x,y,w,h,":"..getResourceName(getThisResource()).."/images/cards/images/bg.png",false,parentElement)
				guiSetAlpha(gImage["cardBG"..cardNR],1)
				local pfad = ":"..getResourceName(getThisResource()).."/images/cards/"..cardColors[getCardColor(card)].."/"..cardIDTypeName[getCardType(card)].."_"..cardColorsShort[getCardColor(card)]..".png"
				gImage["cardDeko1"..cardNR] = guiCreateStaticImage(0.0694,0.1398,0.8681,0.75,":"..getResourceName(getThisResource()).."/images/cards/images/"..getFittingPicture(card)..".png",true,gImage["cardBG"..cardNR])
				gImage["cardDeko2"..cardNR] = guiCreateStaticImage(0.792,0.8475,0.168,0.1243,":"..getResourceName(getThisResource()).."/images/cards/symbols/"..getFittingSymbol(card)..".png",true,gImage["cardDeko1"..cardNR])
				...
				gImage["cardDeko5"..cardNR] = guiCreateStaticImage(0.0903,0.1568,0.1458,0.0847,":"..getResourceName(getThisResource()).."/images/cards/symbols/"..getFittingSymbol(card)..".png",true,gImage["cardBG"..cardNR])
			end
...
function showBlackJackWindow ()
	...
	if isElement ( gWindow["blackJack"] ) then
		...
		gLabel[1] = guiCreateLabel(106,92,50,14,""..Tables.waehrung.." / Chips",false,gWindow["blackJack"])
		...
		gImage[1] = guiCreateStaticImage(16,135,37,40,":"..getResourceName(getThisResource()).."/images/inventory/chip.png",false,gWindow["blackJack"])
...
function blackJackPlaceBet ()
	...
	if amount > 0 then
		if amount <= calcPlayerMaxGambleBet ( lp, 1 ) then
			...
			infobox_start_func ( "Dafuer ist dein\nSpielerskill nicht\nhoch genug!\nMaximaleinsatz:\n"..calcPlayerMaxGambleBet ( lp, 1 ).." "..Tables.waehrung.."", 5000, 125, 0, 0 )
		end
	end
end
