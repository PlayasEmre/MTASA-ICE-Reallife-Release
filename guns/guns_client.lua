...
local blood = guiCreateStaticImage(0,0,1,1,":"..getResourceName(getThisResource()).."/images/bloodscreen.png",true)
guiSetAlpha ( blood, 0 )
...
addEventHandler ( "adminduty", root, startAdminDuty )


function stopAdminDuty ( )
	isadminduty = false
end
addEventHandler ( "adminduty", root, stopAdminDuty )
