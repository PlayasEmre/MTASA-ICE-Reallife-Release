...
function loadTile ( name )
	...
	local file = string.format ( ":"..getResourceName(getThisResource()).."/minimap/sattelite/sattelite_%d_%d.png", row, col )
	...
	local shader = dxCreateShader ( ":"..getResourceName(getThisResource()).."/minimap/texreplace.fx" )
