...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 21. Jul 2022 um 00:58
...
CREATE TABLE `achievments` (
  ...
  `TactickillCoin` tinyint(1) NOT NULL DEFAULT '0'
...
(3, 'WellStackedPizza', 0, 0, 'Well Stacked Pizza Co.', 20000000),
(4, 'MistysBar', 0, 0, 'Mistys Bar', 350000),
(5, 'Visage', 0, 0, 'Visage Hotel', 10000000),
(6, 'VankHoff', 0, 0, 'Vank Hoff Hotel', 3000000),
(7, 'TankstelleNord', 0, 0, 'Tankstelle North', 200000),
(8, 'TankstelleSued', 0, 0, 'Tankstelle South', 750000),
(9, 'TankstellePine', 0, 0, 'Tankstelle Pine', 650000),
(10, 'PaynSprayLV', 0, 0, 'Pay n Spray LV', 500000),
(11, 'PaynSprayLS', 0, 0, 'Pay n Spray LS', 500000);
...
CREATE TABLE `clothes` (
  `Name` varchar(50) NOT NULL,
  `shirt1` text NOT NULL,
  `shirt2` text NOT NULL,
  `hair1` text NOT NULL,
  `hair2` text NOT NULL,
  `hose1` text NOT NULL,
  `hose2` text NOT NULL,
  `schuhe1` text NOT NULL,
  `schuhe2` text NOT NULL,
  `Hut1` text NOT NULL,
  `Hut2` text NOT NULL,
  `Bandana1` text NOT NULL,
  `Bandana2` text NOT NULL
...
('SFPD', 1, '0', '100000', '0', '100000'),
('Mafia', 2, '0', '100000', '0', '100000'),
('Triaden', 3, '0', '100000', '0', '100000'),
('Terroristen', 4, '0', '100000', '0', '100000'),
('Reporter', 5, '0', '100000', '0', '100000'),
('FBI', 6, '0', '100000', '0', '100000'),
('Aztecas', 7, '0', '100000', '0', '100000'),
('army', 8, '0', '100000', '0', '100000'),
('aod', 9, '0', '100000', '0', '100000'),
('medic', 10, '0', '100000', '0', '100000'),
('mechaniker', 11, '0', '100000', '0', '100000'),
('ballas', 12, '0', '100000', '0', '100000'),
('grove', 13, '0', '100000', '0', '100000'),
('Anonymus', 14, '0', '100000', '0', '100000');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gluecksrad`
--

CREATE TABLE `gluecksrad` (
  `UID` int(4) NOT NULL,
  `Tickets` int(10) NOT NULL DEFAULT 0,
  `SpinPeriode` int(11) NOT NULL DEFAULT 0,
  `SpinAnzahl` int(4) NOT NULL DEFAULT 0,
  `LetzteDrehung` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`UID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(2, '743.70001220703', '-1684.5', '862.59997558594', '-1574.4000244141', '786.09997558594', '-1632.4000244141', '13.39999961853', 2, 8, 'Burgershot LS', 1),
(3, '-2201.72', '-280.57', '-2096.76', '-80.93', '-2136.24', '-181.63', '34.96', 2, 1, 'Drogenlabor', 1),
(4, '-2215.40', '-950.06', '-2025', '-700', '-2115.4033203125', '-893.06', '31.67', 3, 7, 'SF Uni', 1),
(5, '-2811.12', '-413.97', '-2634.36', '-261.18', '-2719.86', '-317.43', '7.5', 3, 8, 'Tennisplatz', 1),
(6, '-2293.56', '2226.63', '-2237.42', '2473.87', '-2261.91', '2317.41', '4.46', 3, 4, 'Bayside', 1),
...
(12, '1577.68152', '943.66669', '1756.69226', '1122.69128', '1667.1455078125', '1013.2158203125', '10.8203125', 9, 5, 'Depot', 1),
(13, '1300.3671875', '2102.9736328125', '1397.1962890625', '2198.951171875', '1358.8984375', '2160.513671875', '11.015625', 12, 4, 'Baseballstadion', 1),
(14, '-624.1655273438', '-564.07165527344', '-467.08432006836', '-467.08432006836', '-485.64794921875', '-505.75033569336', '25.517845153809', 12, 4, 'SF Lagerhalle', 1),
(15, '2437.3999023438', '1083.1999511719', '2597.3999023438', '1183.3000488281', '2527.3999023438', '1137.0999755859', '10.699999809265', 12, 9, 'Streets', 0),
(16, '-593.20001220703', '-200.19999694824', '-422.29998779297', '-31.700000762939', '-511.39999389648', '-85.300003051758', '62.200000762939', 13, 10, 'Holzfaeller', 1),
(17, '1860.7937011719', '-1452.2199707031', '1979.2247314453', '-1350.2930908203', '1918.2982177734', '-1400.6328125', '13.5703125', 13, 5, 'Skaterpark', 1),
(18, '807.40002441406', '-1130.0999755859', '952.59997558594', '-1055.5999755859', '862.70001220703', '-1101.9000244141', '24.299999237061', 13, 10, 'Friedhof', 1),
...
(21, '2127.1000976563', '-2345', '2267.8000488281', '-2218.8999023438', '2167.1000976563', '-2274.3999023438', '13.39999961853', 7, 6, 'LS Lagerhalle', 0),
(22, '-2361.49', '-183.31', '-2269.87', '-80.65', '-2308.15', '-123.21', '34.96', 3, 6, 'Burgershot SF', 0),
(23, '-2201.72', '-280.57', '-2096.76', '-80.93', '-2136.24', '-181.63', '34.96', 12, 3, 'Fabrik SF', 0),
(24, '1858.28', '1473.03', '2010.69', '1691', '1908.77', '1518.43', '13.62', 9, 5, 'Piratenschiff', 0),
...
(28, '1277', '903.09997558594', '1497.4000244141', '1183.5999755859', '1398.4000244141', '1097.1999511719', '10.800000190735', 3, 5, 'LV Lagerhalle', 1),
(29, '1358.9000244141', '-2368.8000488281', '1833.9000244141', '-2204.5', '1682.8000488281', '-2285.1000976563', '13.5', 3, 6, 'LS Airport', 1),
(30, '1856.9000244141', '-1255.8000488281', '2061.8000488281', '-1141', '1969.5999755859', '-1187.5999755859', '25.8', 3, 7, 'Glen Park', 1);
...
CREATE TABLE `houses` (
  ...
  `Tier` varchar(10) NOT NULL DEFAULT 'mittel'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `houses` (`ID`, `SymbolX`, `SymbolY`, `SymbolZ`, `UID`, `Preis`, `CurrentInterior`, `Kasse`, `Miete`, `Tier`) VALUES
(153, -2864.962891, 681.462891, 23.460388, 0, 52000, 24, 0, 0, 'mittel'),
(152, -2869.395508, 690.944336, 23.4617, 0, 249000, 14, 0, 0, 'teuer'),
(151, -2872.40625, 697.395508, 23.462742, 0, 73000, 16, 0, 0, 'mittel'),
(150, -2882.349609, 726.676758, 29.196587, 0, 193000, 11, 0, 0, 'teuer'),
(149, -2883.579102, 736.842773, 29.211348, 0, 26000, 6, 0, 0, 'billig'),
(148, -2884.168945, 743.575195, 29.217739, 0, 196000, 11, 0, 0, 'teuer'),
(147, -2884.796875, 750.744141, 29.201218, 0, 63000, 23, 0, 0, 'mittel'),
(146, -2882.260742, 779.995117, 35.089928, 0, 174000, 11, 0, 0, 'teuer'),
(145, -2880.266602, 797.630859, 35.29818, 0, 86000, 0, 0, 0, 'mittel'),
(144, -2868.735352, 821.013672, 39.460468, 0, 85000, 15, 0, 0, 'mittel'),
(143, -2863.667969, 829.803711, 39.53997, 0, 227000, 30, 0, 0, 'teuer'),
(142, -2856.664062, 841.943359, 39.649616, 0, 70000, 23, 0, 0, 'mittel'),
(141, -2840.223633, 866.917969, 44.054688, 0, 47000, 4, 0, 0, 'mittel'),
(140, -2840.227539, 884.605469, 44.054688, 0, 15000, 1, 0, 0, 'billig'),
(139, -2843.214844, 904.429688, 44.054688, 0, 27000, 8, 0, 0, 'billig'),
(138, -2844.089844, 914.423828, 44.054688, 0, 71000, 24, 0, 0, 'mittel'),
(137, -2845.308594, 928.443359, 44.054688, 0, 80000, 16, 0, 0, 'mittel'),
(136, -2853.197266, 947.452148, 44.054688, 0, 35000, 5, 0, 0, 'billig'),
(135, -2857.637695, 956.966797, 44.054688, 0, 25000, 19, 0, 0, 'billig'),
(134, -2860.537109, 963.823242, 44.054688, 0, 230000, 11, 0, 0, 'teuer'),
(133, -2875.985352, 980.888672, 40.72596, 0, 15000, 18, 0, 0, 'billig'),
(132, -2881.033203, 989.631836, 40.71875, 0, 157000, 11, 0, 0, 'teuer'),
(131, -2888.036133, 1001.768555, 40.71875, 0, 77000, 16, 0, 0, 'mittel'),
(130, -2899.106445, 1026.84375, 36.828125, 0, 122000, 3, 0, 0, 'teuer'),
(129, -2895.5625, 1016.867188, 36.828125, 0, 35000, 31, 0, 0, 'billig'),
(128, -2901.662109, 1033.612305, 36.828125, 0, 20000, 22, 0, 0, 'billig'),
(127, -2900.455078, 1056.894531, 32.132812, 0, 214000, 13, 0, 0, 'teuer'),
(126, -2900.712891, 1066.890625, 32.132812, 0, 57000, 4, 0, 0, 'mittel'),
(125, -2900.716797, 1080.936523, 32.132812, 0, 22000, 7, 0, 0, 'billig'),
(124, -2904.47168, 1101.116211, 27.070312, 0, 193000, 11, 0, 0, 'teuer'),
(123, -2904.697266, 1118.751953, 27.070312, 0, 175000, 11, 0, 0, 'teuer'),
(122, -2905.169922, 1164.814453, 13.664062, 0, 32000, 6, 0, 0, 'billig'),
(121, -2904.347656, 1178.96582, 13.664062, 0, 193000, 13, 0, 0, 'teuer'),
(120, -1051.389648, 1549.77832, 33.437611, 0, 28000, 1, 0, 0, 'billig'),
(119, -2027.850586, -40.604492, 38.804688, 0, 215000, 10, 0, 0, 'teuer'),
(111, 1298.5087890625, -797.9853515625, 84.140625, 0, 41000, 15, 0, 0, 'mittel'),
(110, -2034.89453125, 148.5302734375, 28.8359375, 0, 128000, 10, 0, 0, 'teuer'),
(1, -2372.67578125, 692.650390625, 35.1640625, 0, 143000, 10, 0, 0, 'teuer'),
(2, -2372.529296875, 784.1201171875, 35.114852905273, 0, 27000, 5, 0, 0, 'billig'),
(3, -2368.8193359375, 740.6796875, 35.151634216309, 0, 90000, 21, 0, 0, 'mittel'),
(4, -2594.1904296875, 750.8564453125, 33.700843811035, 0, 107000, 30, 0, 0, 'teuer'),
(5, -2594.1875, 785.0849609375, 46.221897125244, 0, 16000, 27, 0, 0, 'billig'),
(6, -2513.5078125, 830.822265625, 49.998344421387, 0, 16000, 1, 0, 0, 'billig'),
(7, -2513.50390625, 867.521484375, 57.7421875, 0, 128000, 3, 0, 0, 'teuer'),
(8, -2513.505859375, 885.755859375, 62.778087615967, 0, 16000, 27, 0, 0, 'billig'),
(9, -2538.73046875, 830.083984375, 49.984375, 0, 79000, 4, 0, 0, 'mittel'),
(10, -2540.6826171875, 855.1171875, 53.1796875, 0, 33000, 17, 0, 0, 'billig'),
(43, -2590.966796875, 819.791015625, 49.991027832031, 0, 104000, 3, 0, 0, 'teuer'),
(44, -2565.87109375, 819.7958984375, 49.991027832031, 0, 23000, 25, 0, 0, 'billig'),
(45, -2559.255859375, 819.7998046875, 49.984375, 0, 34000, 22, 0, 0, 'billig'),
(46, -2548.59765625, 819.794921875, 49.984375, 0, 17000, 6, 0, 0, 'billig'),
(47, -2550.8408203125, 794.1748046875, 49.423389434814, 0, 229000, 10, 0, 0, 'teuer'),
(48, -2586.0087890625, 794.1748046875, 49.423362731934, 0, 53000, 16, 0, 0, 'mittel'),
(49, -2619.7373046875, 845.3515625, 50.598487854004, 0, 117000, 3, 0, 0, 'teuer'),
(50, -2620.01953125, 874.8076171875, 58.921875, 0, 53000, 0, 0, 0, 'mittel'),
(51, -2657.3779296875, 848.6103515625, 64.0078125, 0, 33000, 26, 0, 0, 'billig'),
(52, -2621.677734375, 802.9755859375, 49.984375, 0, 234000, 14, 0, 0, 'teuer'),
(53, -2622.51953125, 782.626953125, 44.859375, 0, 34000, 32, 0, 0, 'billig'),
(54, -2622.521484375, 766.3291015625, 36.8359375, 0, 31000, 25, 0, 0, 'billig'),
(55, -2622.521484375, 749.744140625, 31.421875, 0, 31000, 1, 0, 0, 'billig'),
(56, -2625.48046875, 733.2900390625, 28.010688781738, 0, 34000, 17, 0, 0, 'billig'),
(58, -2640.294921875, 730.84765625, 30.075717926025, 0, 63000, 0, 0, 0, 'mittel'),
(59, -2661.5029296875, 722.2529296875, 27.962381362915, 0, 23000, 18, 0, 0, 'billig'),
(60, -2677.94921875, 722.25390625, 28.595994949341, 0, 30000, 5, 0, 0, 'billig'),
(61, -2706.7939453125, 722.857421875, 37.5390625, 0, 63000, 23, 0, 0, 'mittel'),
(62, -2731.5361328125, 723.703125, 41.2734375, 0, 79000, 0, 0, 0, 'mittel'),
(63, -2738.3154296875, 746.31640625, 49.187034606934, 0, 234000, 3, 0, 0, 'teuer'),
(64, -2738.3232421875, 758.6748046875, 54.3828125, 0, 41000, 24, 0, 0, 'mittel'),
(65, -2738.3134765625, 771.544921875, 54.3828125, 0, 210000, 13, 0, 0, 'teuer'),
(66, -2738.3154296875, 789.0146484375, 54.3828125, 0, 192000, 11, 0, 0, 'teuer'),
(67, -2738.314453125, 801.615234375, 53.0625, 0, 20000, 32, 0, 0, 'billig'),
(68, -2737.8427734375, 836.84765625, 56.25394821167, 0, 19000, 32, 0, 0, 'billig'),
(69, -2737.5546875, 866.3173828125, 64.6328125, 0, 153000, 30, 0, 0, 'teuer'),
(70, -2358.92578125, 1118.0869140625, 55.7265625, 0, 164000, 10, 0, 0, 'teuer'),
(71, -2383.8046875, 1128.1474609375, 55.7265625, 0, 23000, 1, 0, 0, 'billig'),
(72, -2413.53125, 1137.4755859375, 55.7265625, 0, 21000, 28, 0, 0, 'billig'),
(73, -2451.08203125, 1141.7626953125, 55.733276367188, 0, 222000, 30, 0, 0, 'teuer'),
(74, -2478.8564453125, 1141.986328125, 55.7265625, 0, 72000, 23, 0, 0, 'mittel'),
(75, -2517, 1142.41796875, 55.7265625, 0, 213000, 14, 0, 0, 'teuer'),
(76, -2548.9267578125, 1145.7041015625, 55.7265625, 0, 87000, 23, 0, 0, 'mittel'),
(189, -2094.169922, 823.554688, 69.5625, 0, 57000, 4, 0, 0, 'mittel'),
(188, -2112.353516, 823.556641, 69.5625, 0, 24000, 19, 0, 0, 'billig'),
(187, -2159.06543, 830.767578, 69.525543, 0, 69000, 16, 0, 0, 'mittel'),
(186, -2126.194336, 832.734375, 69.5625, 0, 210000, 9, 0, 0, 'teuer'),
(185, -2158.469727, 889.224609, 80.007812, 0, 61000, 15, 0, 0, 'mittel'),
(184, -2129.232422, 894.803711, 80, 0, 73000, 16, 0, 0, 'mittel'),
(183, -2099.494141, 897.357422, 76.710938, 0, 72000, 4, 0, 0, 'mittel'),
(182, -2084.579102, 898.639648, 64.132812, 0, 20000, 27, 0, 0, 'billig'),
(181, -2075.126953, 898.786133, 64.132812, 0, 237000, 14, 0, 0, 'teuer'),
(180, -2034.196289, 901.467773, 50.46648, 0, 28000, 29, 0, 0, 'billig'),
(179, -2016.352539, 897.397461, 45.445312, 0, 33000, 8, 0, 0, 'billig'),
(178, -2018.549805, 865.634766, 45.445312, 0, 86000, 15, 0, 0, 'mittel'),
(177, -2018.545898, 849.376953, 45.448418, 0, 17000, 7, 0, 0, 'billig'),
(176, -2018.547852, 831.972656, 45.445312, 0, 75000, 16, 0, 0, 'mittel'),
(175, -2029.788086, 820.691406, 49.46413, 0, 35000, 8, 0, 0, 'billig'),
(174, -2048.137695, 820.693359, 57.028408, 0, 22000, 6, 0, 0, 'billig'),
(173, -2066.480469, 820.693359, 64.922058, 0, 154000, 11, 0, 0, 'teuer'),
(172, -2094.291992, 746.444336, 69.5625, 0, 231000, 11, 0, 0, 'teuer'),
(171, -2112.652344, 746.445312, 69.5625, 0, 16000, 22, 0, 0, 'billig'),
(170, -2126.041016, 755.476562, 69.5625, 0, 16000, 5, 0, 0, 'billig'),
(169, -2126.041016, 773.835938, 69.5625, 0, 180000, 30, 0, 0, 'teuer'),
(168, -2112.581055, 795.742188, 69.56839, 0, 248000, 11, 0, 0, 'teuer'),
(167, -2094.370117, 795.905273, 69.5625, 0, 30000, 26, 0, 0, 'billig'),
(166, -2066.533203, 796.098633, 64.926529, 0, 64000, 23, 0, 0, 'mittel'),
(165, -2048.167969, 796.098633, 57.035069, 0, 88000, 23, 0, 0, 'mittel'),
(164, -2029.831055, 796.097656, 49.4697, 0, 232000, 11, 0, 0, 'teuer'),
(163, -2066.380859, 746.089844, 64.874023, 0, 221000, 3, 0, 0, 'teuer'),
(162, -2048.238281, 746.086914, 57.053104, 0, 23000, 32, 0, 0, 'billig'),
(161, -2029.924805, 746.09082, 49.474213, 0, 149000, 3, 0, 0, 'teuer'),
(160, -2018.549805, 784.62207, 45.445312, 0, 23000, 8, 0, 0, 'billig'),
(159, -2018.547852, 766.359375, 45.445312, 0, 30000, 6, 0, 0, 'billig'),
(158, -2018.549805, 747.899414, 45.445312, 0, 50000, 0, 0, 0, 'mittel'),
(191, -2121.133789, 349.540039, 35.184376, 0, 88000, 16, 0, 0, 'mittel'),
(192, -2103.635742, 348.770508, 35.171875, 0, 17000, 6, 0, 0, 'billig'),
(193, -2084.144531, 349.700195, 35.184376, 0, 158000, 14, 0, 0, 'teuer'),
(194, -2066.90625, 348.643555, 35.171875, 0, 71000, 15, 0, 0, 'mittel'),
(196, -2710.585938, 968.279297, 54.460938, 0, 30000, 19, 0, 0, 'billig'),
(197, -2655.556641, 986.777344, 64.991287, 0, 56000, 0, 0, 0, 'mittel'),
(198, -2463.196289, 132.03418, 35.171875, 0, 155000, 10, 0, 0, 'teuer');
...
CREATE TABLE `inventar` (
  ...
  `kuerbisse` int(10) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

CREATE TABLE IF NOT EXISTS `gluecksrad` (
`UID` int(4) NOT NULL,
`Tickets` int(10) NOT NULL DEFAULT '0',
`SpinPeriode` int(11) NOT NULL DEFAULT '0',
`SpinAnzahl` int(4) NOT NULL DEFAULT '0',
...
CREATE TABLE `marry` (
  `pl1` varchar(50) NOT NULL,
  `pl2` varchar(50) NOT NULL,
...
CREATE TABLE `players` (
  ...
  `AutologinAus` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `userdata` (
  ...
  `Name` varchar(50) NOT NULL,
  `ID` int(11) NOT NULL,
  `Geld` double NOT NULL DEFAULT 1000,
  `Spawnpos_X` varchar(50) NOT NULL DEFAULT '-1968.6300048828',
  `Spawnpos_Y` varchar(50) NOT NULL DEFAULT '118.84481048584',
  `Spawnpos_Z` varchar(50) NOT NULL DEFAULT '27.6875',
  `Spawnrot_X` varchar(50) NOT NULL DEFAULT '',
  ...
  `Bankgeld` double NOT NULL DEFAULT 7000,
  ...
  `SocialState` varchar(50) NOT NULL DEFAULT 'Neu auf ICE',
  ...
  `PremiumData` datetime DEFAULT NULL,
  `lastSocialChange` int(11) NOT NULL DEFAULT 0,
  `lastNumberChange` int(11) NOT NULL DEFAULT 0,
  `lastPremCarGive` datetime DEFAULT NULL,
  `PremiumCars` int(11) NOT NULL DEFAULT 0,
  `exp` int(255) NOT NULL DEFAULT 0,
  `level` int(255) NOT NULL DEFAULT 0,
  `Introtask` int(11) NOT NULL DEFAULT 1,
  `levelshop1` int(1) NOT NULL DEFAULT 0,
  `levelshop2` int(1) NOT NULL DEFAULT 0,
  `levelshop3` int(1) NOT NULL DEFAULT 0,
  `levelshop4` int(1) NOT NULL DEFAULT 0,
  `TacticKills` int(255) NOT NULL DEFAULT 0,
  `TacticTode` int(255) NOT NULL DEFAULT 0,
  `hatTheorieBestanden` TINYINT(1) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `vehicles` (
  ...
  `totalschaden` int(1) NOT NULL DEFAULT 0,
  `Beschlagnahmt` int(1) NOT NULL DEFAULT 0,
  `KeyTarget` varchar(20) NOT NULL DEFAULT 'none'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Tabellenstruktur für Tabelle `beta_codes`
--

CREATE TABLE `beta_codes` (
  `Code` varchar(32) NOT NULL,
  `Benutzt` tinyint(1) NOT NULL DEFAULT 0,
  `BenutztVonSerial` varchar(32) NOT NULL DEFAULT '',
  `ErstelltVon` varchar(32) NOT NULL DEFAULT '',
  `ErstelltAm` datetime DEFAULT NULL,
  `BenutztAm` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Indizes für die Tabelle `beta_codes`
--
...
--
-- Tabellenstruktur für Tabelle `beta_zugang`
--

CREATE TABLE `beta_zugang` (
  `Serial` varchar(32) NOT NULL,
  `SeitWann` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Indizes für die Tabelle `beta_zugang`
--
ALTER TABLE `beta_zugang`
  ADD PRIMARY KEY (`Serial`);
COMMIT;
...
--
-- AUTO_INCREMENT für Tabelle `buyit`
--
ALTER TABLE `buyit`
