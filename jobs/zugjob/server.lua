...
function ZugJobIconHit_func ( player )
	if MtxGetElementData ( player, "job" ) == "zugfuehrer" and not getPedOccupiedVehicle ( player ) then
...
function startTheZugJob ( player )
	if MtxGetElementData ( player, "job" ) == "zugfuehrer" then
		...
		if getDistanceBetweenPoints3D ( x, y, z, -1974, 117.69999694824, 27.700000762939 ) <= 5 then
			if not MtxGetElementData ( player, "jailtime" ) or MtxGetElementData ( player, "jailtime" ) <= 0 then
				if not MtxGetElementData ( player, "prison" ) or MtxGetElementData ( player, "prison" ) <= 0 then
					if not MtxGetElementData ( player, "heaventime" ) or MtxGetElementData ( player, "heaventime" ) <= 0 then
...
function startTheZugJobPhaseZwei ( player )
	...
	MtxSetElementData ( player, "imzugjob", 1 )
...
function brecheZugJobAb ( thePlayer )
	...
	MtxSetElementData ( player, "imzugjob", 0 )
