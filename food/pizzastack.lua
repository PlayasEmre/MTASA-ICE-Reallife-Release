...
function pizzaBuySFCenterHit ( player, dim )
	...
	if dim == true then
		MtxSetElementData ( player, "intdim", getElementDimension ( player ) )
		MtxSetElementData ( player, "curpizza", 1 )
...
function pizzaLeave ( player )
	...
	setElementDimension ( player, MtxGetElementData ( player, "intdim" ) )
...
function pizzaLeft ( player )
	...
	local pizza = tonumber ( MtxGetElementData ( player, "curpizza" ) )
	if pizza == 1 then
		pizza = 4
	elseif pizza == 2 then
		pizza = 1
...
function pizzaRight ( player )
	...
	local pizza = MtxGetElementData ( player, "curpizza" )
	if pizza == 1 then
		pizza = 2
	elseif pizza == 2 then
		pizza = 3
...
function pizzaLookCheck ( player, pizza )
	...
	MtxSetElementData ( player, "curpizza", pizza )
	if pizza == 1 then
		local px, py, pz = getElementPosition ( healthyPizza )
		setCameraMatrix ( player, px-.04, py-0.4, pz+0.5, px, py, pz )
...
function pizzaBuy ( player )
	...
	if pmoney >= pizzaprice then
		...
		MtxSetElementData ( player, "money", pmoney - pizzaprice )
